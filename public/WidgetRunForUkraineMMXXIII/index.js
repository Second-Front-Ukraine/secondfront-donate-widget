...
function StackedBoxAmountSelector(props) {
  return (0, _jsxRuntime.jsxs)("div", __assign({
    ...
    children: [(0, _jsxRuntime.jsx)("h3", {
      children: props.promptText || "Select amount to donate"
...
exports.default = _default;
},{"react/jsx-runtime":"plwR","react":"n8MK","./widgetTorMarathon.css":"vKFU","./components/DonateForm":"ifG6","./axiosInstances":"EICV"}],"JtXs":[function(require,module,exports) {
"use strict";
...
require("./widgetRunForUkraineMMXXIII.css");
...
function WidgetRunForUkraineMMXXIII(props) {
  var _a = (0, _react.useState)({
    slug: props.campaign,
    collected: 0
  }),
...
var _WidgetRunForUkraineMMXXIII = _interopRequireDefault(require("./WidgetRunForUkraineMMXXIII"));

var _WidgetRunForUkraineRunReg = _interopRequireDefault(require("./WidgetRunForUkraineRunReg"));

var _reportWebVitals = _interopRequireDefault(require("./reportWebVitals"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

if ("WidgetRunForUkraineMMXXIII" === 'WidgetTorMarathon') {
...
} else if ("WidgetRunForUkraineMMXXIII" === 'WidgetRunForUkraineMMXXIII') {
  var widgetDivs = document.querySelectorAll('.secondfront-donate-widget');
  widgetDivs.forEach(function (div) {
    _client.default.createRoot(div).render((0, _jsxRuntime.jsx)(_react.default.StrictMode, {
      children: (0, _jsxRuntime.jsx)(_WidgetRunForUkraineMMXXIII.default, {
        campaign: div.dataset.campaign || '',
        targetCollections: +(div.dataset.targetCollections || "0")
      })
    }));
  });
} else if ("WidgetRunForUkraineMMXXIII" === 'WidgetRunForUkraineRunReg') {
  var widgetDivs = document.querySelectorAll('.runforukraine-register-widget');
  widgetDivs.forEach(function (div) {
    _client.default.createRoot(div).render((0, _jsxRuntime.jsx)(_react.default.StrictMode, {
      children: (0, _jsxRuntime.jsx)(_WidgetRunForUkraineRunReg.default, {
        campaign: div.dataset.campaign || '',
        targetCollections: +(div.dataset.targetCollections || "0")
      })
    }));

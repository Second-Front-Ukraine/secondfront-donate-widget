	...
	return (
		<div className="2fua-donate-form">
			<div className="sfua-donate-form__amount-select">
				<span>
					<button onClick={() => setAmount('25.00')}>$25</button> |{' '}
					<button onClick={() => setAmount('50.00')}>$50</button> |{' '}
					<button onClick={() => setAmount('100.00')}>$100</button>
				</span>
			</div>
			<form onSubmit={handleSubmit}>
				<div className="sfua-donate-form__input-box">
					<span className="sfua-donate-form__input-box__prefix">
						CAD
					</span>
					<input
						type="text"
				...
				{!addIdentity || !addNote ? (
					<div className="sfua-donate-form__add">
						{!addIdentity ? (
							<button onClick={() => setAddIdentity(true)}>
